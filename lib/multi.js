...
module.exports = MultiCache = (function(){
  ...
  function MultiCache(localCache, remoteCache, options) {
    ...
    this.localCache = typeof localCache === 'string' ? createCache(localCache, options.local) : localCache;
    this.remoteCache = typeof remoteCache === 'string' ? createCache(remoteCache, options.remote) : remoteCache;
  }
